 ...
 * as the output.
 */
// TODO: SORT OUT THE DEPRECATION YO!!!
public class GeofenceTransitionsWorker extends Worker {
    ...
    public GeofenceTransitionsWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public static void enqueueWork(Context context, Intent intent) {
        ...
        //final Data data = Data.Builder().putString(YOUR_PARAM, yourParameter).build();
        GeofencingEvent geofencingEvent = GeofencingEvent.fromIntent(intent);
        if(geofencingEvent == null) {
            Log.e("Geofence", "Geofence intent is null! Have geofences been re-registerd?");
            return;
        }
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            dataBuilder.putString("DETAILS", geofenceTransitionDetails);

            // TODO: This may need to return something to the calling code?
            final WorkRequest workRequest = new OneTimeWorkRequest.Builder(GeofenceTransitionsWorker.class)
...
//        } else {
//            // Log the error.
//            Log.e(TAG, mContext.getString(R.string.geofence_transition_invalid_type, geofenceTransition));
//        }
//    }
    ...
    public Result doWork() {
        ...
        final String details = data.getString("DETAILS");
