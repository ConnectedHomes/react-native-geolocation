            ...
            switch (resultCode) {
                ...
                case Activity.RESULT_CANCELED:
                    ...
                    if(this.positionFailureCallback != null) {
                        final WritableMap errorMap = Arguments.createMap();
                        errorMap.putString("message", "High location accuracy not enabled!");
                        errorMap.putString("code", String.valueOf(LocationError.LOCATION_SETTINGS_FAILED));
                        this.positionFailureCallback.invoke(errorMap);
                    }
                    break;
                default:
                    break;
