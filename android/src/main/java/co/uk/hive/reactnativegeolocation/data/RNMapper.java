...
public class RNMapper {
    public Geofence readGeofence(ReadableMap map) {
        return new Geofence(
    ...
    public WritableMap writeLocation(LatLng location) {
    ...
    public CurrentPositionRequest readPositionRequest(ReadableMap readableMap) {
